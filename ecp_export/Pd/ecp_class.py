...
my_ecp = ECP(element = "Pd", core = 28)
my_ecp.read_ecp_so('pp.d')

my_ecp.write_molpro('Pd.ccECP.molpro')
my_ecp.write_nwchem('Pd.ccECP.nwchem')
my_ecp.write_gamess('Pd.ccECP.gamess')
my_ecp.write_dirac('Pd.ccECP.dirac')
my_ecp.write_qwalk_so('Pd.ccECP.qwalk')
my_ecp.write_manuscript('Pd.ccECP.man')
