...
my_ecp = ECP(element = "W", core = 60)
my_ecp.read_ecp_so('W.ccECP')

my_ecp.write_molpro('W.ccECP.molpro')
my_ecp.write_nwchem('W.ccECP.nwchem')
my_ecp.write_gamess('W.ccECP.gamess')
my_ecp.write_dirac('W.ccECP.dirac')
#my_ecp.write_qwalk_so('W.ccECP.qwalk')
#my_ecp.write_manuscript('W.man')
