...
binding = pd.read_csv("qzbind", delim_whitespace=True)
print binding
...
#x = np.linspace(1.3,2.0,20)

plt.plot(binding['r'], binding['bind'],'b*')
rx = np.linspace(1.40,2.30,50)
plt.plot(rx,morse(rx,*popt_m),'r-')
plt.show()
