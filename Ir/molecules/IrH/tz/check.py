...
for basis in ['tz']:
        bkc1_1 = pd.read_csv('./'+basis+'.bk9.5.1.csv',skip_blank_lines=True,skipinitialspace=True)
...
#
work = pd.DataFrame()
work['bkc1.1 Raw'] = bk4ccsd['tz_ccsd']
...
ecps = ['MDFSTU', 'LANL2', 'SBKJC', 'CRENBL', 'bk8.4.1', 'bk9.5.1']
