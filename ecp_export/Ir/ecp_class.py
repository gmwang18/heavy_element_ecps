...
my_ecp = ECP(element = "Ir", core = 60)
my_ecp.read_ecp_so('pp.d')

my_ecp.write_molpro('Ir.ccECP.molpro')
my_ecp.write_nwchem('Ir.ccECP.nwchem')
my_ecp.write_gamess('Ir.ccECP.gamess')
my_ecp.write_dirac('Ir.ccECP.dirac')
my_ecp.write_qwalk_so('Ir.ccECP.qwalk')
my_ecp.write_manuscript('Ir.ccECP.man')
