...
my_ecp = ECP(element = "Au", core = 60)
my_ecp.read_ecp_so('pp.d')

my_ecp.write_molpro('Au.ccECP.molpro')
my_ecp.write_nwchem('Au.ccECP.nwchem')
my_ecp.write_gamess('Au.ccECP.gamess')
my_ecp.write_dirac('Au.ccECP.dirac')
my_ecp.write_qwalk_so('Au.ccECP.qwalk')
my_ecp.write_manuscript('Au.ccECP.man')
