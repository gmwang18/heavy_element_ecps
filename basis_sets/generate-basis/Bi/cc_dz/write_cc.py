...
params = np.array([
0.031923,	# Lowest s exponent
2.500000,	# Ratio for s exponents
0.064846,	# Lowest p exponent
2.500000,	# Ratio for p exponents
0.175355,	# Lowest d exponent
2.500000,	# Ratio for d exponents
])
