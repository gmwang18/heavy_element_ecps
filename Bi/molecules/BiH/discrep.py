...
ecps = ['UC', 'BFD', 'MDFSTU','MWBSTU','CRENBS','SBKJC','LANL2', 'a-3.1', 'a-5.0']
styles = {
...
'a-3.1'	        :{'label': 'a-3.1',	'color':'#009900','linestyle':'--','dashes': (3,3)	},
'a-5.0'	        :{'label': 'a-5.0',	'color':'#6600ff','linestyle':'--','dashes': (3,3)	},
