...
s,Te,s_exp(1),s_exp(2),s_exp(3),s_exp(4),s_exp(5)
p,Te,p_exp(1),p_exp(2),p_exp(3),p_exp(4),p_exp(5)
d,Te,d_exp(1),d_exp(2),d_exp(3),d_exp(4),d_exp(5)
f,Te,f_exp(1),f_exp(2),f_exp(3),f_exp(4)
g,Te,g_exp(1),g_exp(2),g_exp(3)
h,Te,h_exp(1),h_exp(2)
i,Te,i_exp(1)
