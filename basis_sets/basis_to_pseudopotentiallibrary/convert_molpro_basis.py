...
if __name__ == "__main__":
    ...
    found_atoms = set() # This set will help in case many elements are defined by mistake
    ...
    # Check if many elements were defined by mistake
    if len(found_atoms) > 1:
        print('More than one elements were found! Check the source Molpro file for typos!')
        sys.exit()
