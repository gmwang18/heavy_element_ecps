...
my_ecp = ECP(element = "Te", core = 46)
my_ecp.read_ecp_so('pp.d')

my_ecp.write_molpro('Te.ccECP.molpro')
my_ecp.write_nwchem('Te.ccECP.nwchem')
my_ecp.write_gamess('Te.ccECP.gamess')
my_ecp.write_dirac('Te.ccECP.dirac')
my_ecp.write_qwalk_so('Te.ccECP.qwalk')
my_ecp.write_manuscript('Te.ccECP.man')
