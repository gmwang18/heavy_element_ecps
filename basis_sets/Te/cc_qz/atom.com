...
s,Te,s_exp(1),s_exp(2),s_exp(3)
p,Te,p_exp(1),p_exp(2),p_exp(3)
d,Te,d_exp(1),d_exp(2),d_exp(3)
f,Te,f_exp(1),f_exp(2)
g,Te,g_exp(1)
...
{minimize,eval,s_par(1),s_par(2),p_par(1),p_par(2),d_par(1),d_par(2),f_par(1),f_par(2),g_par(1)
