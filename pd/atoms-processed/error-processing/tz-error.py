...
weight_er['bk1.0 error'] = (fff['bk1.0'].values - fff['all electron'].values)/fff['all electron'].values
weight_er['bk1.1 error'] = (fff['bk1.1'].values - fff['all electron'].values)/fff['all electron'].values
weight_er['bk1.2 error'] = (fff['bk1.2'].values - fff['all electron'].values)/fff['all electron'].values
weight_er['bk1.3 error'] = (fff['bk1.3'].values - fff['all electron'].values)/fff['all electron'].values
weight_er['bk1.4 error'] = (fff['bk1.4'].values - fff['all electron'].values)/fff['all electron'].values
