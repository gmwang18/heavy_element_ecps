...
for basis in ['tz']:
    b = pd.read_csv('./'+basis+'.ae.csv',skip_blank_lines=True,skipinitialspace=True)
    scfae[basis+'_scf'] = b['SCF']

scf = scfae.filter(regex='scf')
...
#print(bk2_1.to_latex(index=False))
