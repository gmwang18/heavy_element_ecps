...
params = np.array([
0.109763,	# Lowest s exponent
2.930500,	# Ratio for s exponents
0.080511,	# Lowest p exponent
5.144208,	# Ratio for p exponents
0.185583,	# Lowest d exponent
1.384621,	# Ratio for d exponents
