...
ecps = ['UC','MWBSTU','MDFSTU','CRENBL','SBKJC','LANL2','bk2.0','bk2.4','bk3.2']
styles = {
...
'bk1.1'		:{'label':'bk1.1',	'color':'#009900','linestyle':'--','dashes': (3,3) },
'bk2.0'		:{'label':'bk2.0',	'color':'#003366','linestyle':'--','dashes': (3,3) },
'bk2.4'		:{'label':'bk2.4',	'color':'#009900','linestyle':'--','dashes': (3,3) },
'bk3.2'		:{'label':'bk3.2',	'color':'#559900','linestyle':'--','dashes': (3,3) },
}
