...
for basis in ['tz']:
        bk = pd.read_csv('./'+basis+'.UC.csv',skip_blank_lines=True,skipinitialspace=True)
        dfUC[basis+'_z'] = bk['Z']
        dfUC[basis+'_ccsd'] = bk['CCSD']
...
work['AE proc'] = work['AE Raw'].values  - -0.49982785 --17830.04119
work['UC Raw'] = UCccsd['tz_ccsd'] 
work['UC proc'] = work['UC Raw'].values - -0.49982785 --17827.49830
work['MDFSTU Raw'] = stuccsd['tz_ccsd'] 
work['MDFSTU proc'] = work['MDFSTU Raw'].values - -0.49982785 --104.2302524
work['bk1.6 Raw'] = bk1_6ccsd['tz_ccsd']
work['bk1.6 proc'] = work['bk1.6 Raw'].values - -0.49982785 --104.3720361
work['bk1.7 Raw'] = bk1_7ccsd['tz_ccsd']
work['bk1.7 proc'] = work['bk1.7 Raw'].values - -0.49982785 --104.3727376
work['bk1.8 Raw'] = bk1_8ccsd['tz_ccsd']
work['bk1.8 proc'] = work['bk1.8 Raw'].values - -0.49982785 --104.3975152
...
work['LANL2 proc'] = work['LANL2 Raw'].values - -0.49982785 --104.5501705
work['SBKJC Raw'] = SBKJccsd['tz_ccsd']
work['SBKJC proc'] = work['SBKJC Raw'].values - -0.49982785 --104.5826961
...
def plot(df):
    ...
    ax.set_xlim((x[0],x[-1]))
    ax.axvline(1.600,color='black',linestyle='--',linewidth=1.5,dashes=(2,2))
