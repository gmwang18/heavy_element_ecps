...
ecps = ['UC','CRENBL','LANL2','SBKJC','MDFSTU','MWBSTU','ccECP']
styles = {
...
def get_data():
	ae = pd.read_csv('AE/5zbind', delim_whitespace=True, index_col='r')
	dfs = pd.DataFrame()
	for ecp in ecps:
		df = pd.read_csv(ecp+'/5zbind', delim_whitespace=True)
		dfs[ecp] = df['bind']
