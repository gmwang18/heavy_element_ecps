...
my_ecp = ECP(element = "Mo", core = 28)
my_ecp.read_ecp_so('pp.d')

my_ecp.write_molpro('Mo.ccECP.molpro')
my_ecp.write_nwchem('Mo.ccECP.nwchem')
my_ecp.write_gamess('Mo.ccECP.gamess')
my_ecp.write_dirac('Mo.ccECP.dirac')
my_ecp.write_qwalk_so('Mo.ccECP.qwalk')
my_ecp.write_manuscript('Mo.ccECP.man')
