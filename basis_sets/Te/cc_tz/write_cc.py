...
params = np.array([
0.109814,	# Lowest s exponent
4.429686,	# Ratio for s exponents
0.092371,	# Lowest p exponent
5.619692,	# Ratio for p exponents
0.167486,	# Lowest d exponent
1.875100,	# Ratio for d exponents
0.356372,	# Lowest f exponent
