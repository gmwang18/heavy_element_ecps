...
for basis in ['tz']:
    a41 = pd.read_csv('./'+basis+'.bkc1.1.csv',skip_blank_lines=True,skipinitialspace=True)
    dfc1_1[basis+'_ccsd'] = a41['CCSD']

bkc1_1 = dfc1_1.filter(regex='ccsd')



scfc1_1=pd.DataFrame()

for basis in ['tz']:
    b41 = pd.read_csv('./'+basis+'.bkc1.1.csv',skip_blank_lines=True,skipinitialspace=True)
    scfc1_1[basis+'_scf'] = b41['SCF']
...
for basis in ['tz']:
    a_bkc5_1 = pd.read_csv('./'+basis+'.bkc5.1.csv',skip_blank_lines=True,skipinitialspace=True)
    dfbkc5_1[basis+'_ccsd'] = a_bkc5_1['CCSD']

bkc5_1 = dfbkc5_1.filter(regex='ccsd')



scfbkc5_1=pd.DataFrame()

for basis in ['tz']:
    b_bkc5_1 = pd.read_csv('./'+basis+'.bkc5.1.csv',skip_blank_lines=True,skipinitialspace=True)
    scfbkc5_1[basis+'_scf'] = b_bkc5_1['SCF']
...
ff['bkc1.1'] = dfc1_1['tz_ccsd']
ff['bkc1.1 gaps'] = ff['bkc1.1'].values - ff['bkc1.1'].values[0]
ff['bkc1.1 corr'] = ff['bkc1.1 gaps'].values - (scfc1_1['tz_scf'].values - scfc1_1['tz_scf'].values[0])
ff['bkc5.1'] = dfbkc5_1['tz_ccsd']
ff['bkc5.1 gaps'] = ff['bkc5.1'].values - ff['bkc5.1'].values[0]
ff['bkc5.1 corr'] = ff['bkc5.1 gaps'].values - (scfbkc5_1['tz_scf'].values - scfbkc5_1['tz_scf'].values[0])
...
fff['bkc1.1'] = ff['bkc1.1 gaps'].values*toev
fff['bkc5.1'] = ff['bkc5.1 gaps'].values*toev
...
er['bkc1.1 error'] = fff['bkc1.1'].values - fff['all electron'].values
er['bkc5.1 error'] = fff['bkc5.1'].values - fff['all electron'].values
...
opt['bkc1.1 opt'] = opt['ae gaps'].values - ff['bkc1.1 corr'].values*toev
opt['bkc5.1 opt'] = opt['ae gaps'].values - ff['bkc5.1 corr'].values*toev
