...
f_par=[0.273700, 2.035440]
g_par=[0.449600, 2.513790]
h_par=[0.810700, 2.485260]
i_par=[1.682200, 2.500000]
...
f,Au,f_exp(1),f_exp(2),f_exp(3),f_exp(4)
g,Au,g_exp(1),g_exp(2),g_exp(3)
h,Au,h_exp(1),h_exp(2)
i,Au,i_exp(1)
